    ...
    <div className="chamfer-sm border border-[rgba(0,229,255,0.2)] bg-[rgba(8,16,26,0.55)] hover:border-[rgba(0,229,255,0.4)] hover:bg-[rgba(10,22,34,0.65)] p-2.5 flex flex-col gap-1.5 transition-all duration-200 shadow-[0_0_15px_rgba(0,229,255,0.04),inset_0_1px_0_rgba(255,255,255,0.04)]">
      <div className="flex justify-between items-center text-xs">
        <div className="flex items-center gap-1.5">
          <div className="p-1 chamfer-xs bg-[rgba(0,229,255,0.1)] border border-[rgba(0,229,255,0.25)]">
            <Cpu className="w-3 h-3 text-[#00E5FF]" />
          </div>
          <span className="text-[#00E5FF] font-['Orbitron',sans-serif] text-[11px] font-bold tracking-wider">
            CPU
          </span>
        </div>
        <div className="flex items-baseline gap-1 font-mono">
          <span className="text-white font-bold text-xs drop-shadow-[0_0_8px_rgba(0,229,255,0.4)]">
            {cpu}%
          </span>

        </div>
      </div>
      <div className="h-1.5 w-full bg-[rgba(0,229,255,0.08)] border border-[rgba(0,229,255,0.18)] chamfer-xs overflow-hidden">
        <div
          className="h-full bg-gradient-to-r from-[#0090FF] via-[#00E5FF] to-[#70F0FF] chamfer-xs transition-all duration-300 shadow-[0_0_8px_rgba(0,229,255,0.6)]"
    ...
    <div className="chamfer-sm border border-[rgba(0,229,255,0.2)] bg-[rgba(8,16,26,0.55)] hover:border-[rgba(0,229,255,0.4)] p-2.5 flex flex-col gap-1.5 shadow-sm">
      <div className="flex justify-between items-center text-xs">
        ...
        <div className="flex items-center gap-2 font-mono">
          <span className="text-white font-bold drop-shadow-[0_0_8px_rgba(0,229,255,0.4)]">
            {fps} FPS
          </span>
...
const HostStatsCard = React.memo(function HostStatsCard() {
  ...
  return (
    <div className="chamfer-sm border border-[rgba(0,229,255,0.2)] bg-[rgba(8,16,26,0.55)] p-2.5 flex flex-col gap-2 shadow-[0_0_15px_rgba(0,229,255,0.04),inset_0_1px_0_rgba(255,255,255,0.04)]">
      <div className="flex items-center justify-between border-b border-[rgba(0,229,255,0.12)] pb-1.5">
        <span className="text-[10px] font-['Orbitron',sans-serif] font-bold text-[#00E5FF] tracking-wider flex items-center gap-1.5">
          <Terminal className="w-3 h-3 text-[#00E5FF]" />
          HOST ARCHITECTURE
        </span>
        <span className="text-[9px] font-mono px-1.5 py-0.5 chamfer-xs bg-[rgba(0,229,255,0.1)] border border-[rgba(0,229,255,0.25)] text-[#00E5FF] font-bold">
          {osTag}
        </span>
      </div>

      <div className="grid grid-cols-2 gap-2 text-[11px] font-mono">
        <div className="flex flex-col gap-0.5 p-1.5 chamfer-xs bg-[rgba(0,229,255,0.04)] border border-[rgba(0,229,255,0.12)]">
          <div className="flex items-center gap-1 text-[#7E859E] text-[10px]">
            <Clock className="w-2.5 h-2.5 text-[#00E5FF]" />
            <span>UPTIME</span>
          </div>
          <span className="text-white font-bold text-xs drop-shadow-[0_0_6px_rgba(0,229,255,0.3)]">
            {uptime}
          </span>
        </div>
        ...
        <div className="flex flex-col gap-0.5 p-1.5 chamfer-xs bg-[rgba(0,229,255,0.04)] border border-[rgba(0,229,255,0.12)]">
          <div className="flex items-center gap-1 text-[#7E859E] text-[10px]">
            <Server className="w-2.5 h-2.5 text-[#00E5FF]" />
            <span>PROCESSES</span>
          </div>
          <span className="text-white font-bold text-xs drop-shadow-[0_0_6px_rgba(0,229,255,0.3)]">
            {proc}
...
function TelemetryPanelComponent({ isConnected, onToggleConnection }) {
  ...
  return (
    <aside
      className={`fixed top-18 left-6 h-[44vh] max-h-[440px] w-88 sm:w-96 max-w-[calc(100vw-3rem)] z-30 flex flex-col bg-[rgba(8,12,18,0.55)] backdrop-blur-xl backdrop-saturate-150 border border-[rgba(0,229,255,0.25)] shadow-[0_0_40px_rgba(0,229,255,0.12),inset_0_1px_0_rgba(255,255,255,0.06)] chamfer-xl overflow-hidden text-[#F0F2F8] font-mono select-none pointer-events-auto p-3.5 gap-2.5 ${isClosing ? "scifi-modal-collapse-up" : "scifi-modal-unfold-down"
        }`}>
      {/* TOP ACCENT LINE */}
      ...
      <div className="flex items-center justify-between border-b border-[rgba(0,229,255,0.18)] pb-2 shrink-0">
        <div className="flex items-center gap-2">
          <div className="w-2.5 h-2.5 bg-[#00E5FF] rounded-full animate-pulse shadow-[0_0_8px_#00E5FF]" />
          <div className="flex flex-col">
            <span className="text-sm font-['Orbitron',sans-serif] font-black tracking-widest text-[#00E5FF]">
              SYSTEMS PANEL
            </span>
